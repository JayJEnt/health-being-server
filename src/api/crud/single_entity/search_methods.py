...
async def search_elements(element_type: str, phrase: str, restrict: bool=False) -> list:
    """
    ...
    for search_column in config["search_columns"]:
        ...
        try:
            ...
            logger.info(f"{element_type} with phrase={phrase} not found in column={search_column}")

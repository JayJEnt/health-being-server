...
async def get_vitamins():
    return await crud.get("vitamins")
...
async def get_vitamin(vitamin_id: int):
    return await crud.get_by_id("vitamins", vitamin_id)
...
async def get_vitamin_by_name(vitamin_name: str):
    return await crud.get_by_name("vitamins", vitamin_name)
...
async def create_vitamin(vitamin: VitaminCreate):
    return await crud.post("vitamins", vitamin)
